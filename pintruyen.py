...
class API:
    ...
    def get(param: str, *args, urlSigner = Sign.URL, useFollowUrl = False, impersonate = "chrome124", **kwargs):
        return sess.get(urlSigner(param, useFollowUrl), impersonate=impersonate, timeout=10, *args, **kwargs).text
        
    @type.jsondec
    def post(*args, impersonate = "chrome124", **kwargs):
        return sess.post(*args, impersonate=impersonate, timeout=10, **kwargs).text
